...
def find_rectangular_overlap(rect1, rect2):
    ...
    bottom_x = max(rect1['left_x'], rect2['left_x'])
    bottom_y = max(rect1['bottom_y'], rect2['bottom_y'])
    
    top_x = min((rect1['left_x']+rect1['width']), (rect2['left_x']+rect2['width']))
    top_y = min((rect1['bottom_y']+rect1['height']), (rect2['bottom_y']+rect2['height']))
